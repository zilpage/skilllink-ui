...
function App() {
  return (
    <div className="App">
      <Navigation />
      <div
        className="wpo-mission-area section-padding"
        style={{ color: "black" }}
      >
        <div className="container">
          <div className="row">
            ...
            <div className="col-12">
              <p>
                We are open to sponsorships from corporate organizations, as an
                opportunity to increase their Sustainability and CSR footprint.
              </p>
            </div>
            <div className="col-12">
              <h5>
              ...
              <div className="row">
                <div className="col-4">
                  <p>
                    <h5>Sponsorship </h5>
                    <br />
                    We are open to sponsorships from corporate organizations. We
                    provide corporate organizations with opportunities to
                    increase sustainability and CSR footprint.
                  </p>
                </div>
                ...
                <div className="col-4">
                  <p>
                    <h5>Donations</h5>
                    <br />
                    We are supported with donations from well-meaning
                    individuals as part of their contributions to human
                    development.
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-6 col-md-12 colsm-12">
              <div className="wpo-about-text">
                ...
                <p>
                  ...
                  <li>
                    - Build brand reputation and loyalty as a forward-thinking
                    and socially responsible entity
                  </li>
                  <li>
                    - Build solid business ties with technical leaders of
                    tomorrow which ensures business sustainability
                  </li>
                  <li>
                    - Leverage a platform for brand promotion as brand assets
                    will be shared across our platforms with a fast-growing
                    reach.
                  </li>
                </p>
              </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 col-md-12 colsm-12">
              <div className="wpo-about-text">
                <div className="wpo-section-title">
                  <span>Train a Girl Child, Train the Nation.</span>
                  <h2></h2>
                </div>

                <p>
                  Individuals can also make donations as their contribution to
                  human development. For donations, sponsorships, and support,
                  kindly write to: info@skilllink.org.com, or call: +234 703
                  9378 492
                </p>
