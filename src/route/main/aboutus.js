                        ...
                        <div className="wpo-case-slider">
                            <div className="slick-slider slick-initialized" dir="ltr">
                                ...
                                <div className="slick-list">
                                    <div className="slick-track" style={{ width: '4070px', opacity: 1, transform: 'translate3d(-1850px, 0px, 0px)' }}><div data-index={-3} tabIndex={-1} className="slick-slide slick-cloned" aria-hidden="true" style={{ width: '370px' }}>
                                        <div>
                                        ...
                                        <div data-index={1} className="slick-slide" tabIndex={-1} aria-hidden="true" style={{ outline: 'none', width: '370px' }}>
                                            ...
                                            </div></div><div data-index={2} className="slick-slide slick-active slick-current" tabIndex={-1} aria-hidden="false" style={{ outline: 'none', width: '370px' }}>
                                            <div>
                                                <div className="wpo-case-single" tabIndex={-1} style={{ width: '100%', display: 'inline-block' }}>
                                                    <div className="wpo-case-item">
                                                        <div className="wpo-case-img"><img src="/static/media/img-3.6d6b3c93.png" alt="" /></div>
