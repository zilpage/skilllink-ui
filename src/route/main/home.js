    ...
    return (
      <div className="App" id="scrool">
        <div className="App">
          ...
          {/*</div>
                      <div className="btns">
                        <Link className="theme-btn" to="/aboutus">
                          Learn More
                        </Link>
                      </div>
                    </div>
              ...
              <div className="row">
                <div className="col-lg-6 col-md-12 colsm-12">
                  <div className="wpo-about-text" style={{ marginTop: "25%" }}>
                    ...
                    <br />
                    <p>
                      We believe that the girl child is vibrant, creative, and
                      smart and that she deserves the freedom to dream, and to
                      pursue her dreams.
                    </p>
                  </div>
                </div>
                ...
                <div className="col-lg-6 col-md-12 colsm-12">
                  <div className="wpo-about-text" style={{ marginTop: "25%" }}>
                    ...
                    <br />
                    <p>
                      With the right opportunities, talented young girls from
                      disadvantaged backgrounds are empowered to transform their
          ...
          <div
            className="wpo-mission-area undefined"
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-12 col-12 custom-grid">
                    <div className="wpo-mission-item">
                      ...
                      <div className="wpo-mission-content">
                        <h2>Discover</h2>
                        <p>
                          We identify the girls in their various locations and
                    ...
                    <div className="wpo-mission-item">
                      ...
                      <div className="wpo-mission-content">
                        ...
                        <p>
                          ...
                          <br />
                          - Take place in the facilities of our corporate
                          partners and are implemented by their employees.
                          <br />
                        </p>
                      </div>
                    </div>
              ...
              <div className="row">
                <div className="col-lg-6 col-md-12 colsm-12">
                  <div className="wpo-about-text">
                    ...
                    <p>
                      We recognize that the work we do is important for both the
                      Nigerian girl and the society, and we believe that with
                      the support of individuals and organizations looking to
                      make a positive contribution to society, we can make the
                      most impact and transform society through our work,
                    </p>
                              ...
                              >
                                <div className="wpo-case-item">
                                  <div className="wpo-case-img">
                                    <img
                                      src="/static/media/img-2.7f30d201.png"
                                      alt=""
                                    />
                                  </div>
                                  <div className="wpo-case-content">
                                    ...
                                    <div className="case-btn">
                                      <ul>
                                        <li>
                                          <a href="/case-single">Learn More</a>
                                        </li>
                                        <li>
                            ...
                            <div>
                              ...
                              >
                                <div className="wpo-case-item">
                                  <div className="wpo-case-img">
                                    <img
                                      src="/static/media/img-3.6d6b3c93.png"
                                      alt=""
                                    />
                                  </div>
                                  <div className="wpo-case-content">
                          ...
                          {result &&
                            ...
                            result.list.map((item, i) => {
                              return (
                                <div
                                  data-index={1}
                                  className="slick-slide slick-actives slick-currents"
                                  tabIndex={-0}
                                  aria-hidden="false"
                                  style={{ width: "370px" }}
                                >
