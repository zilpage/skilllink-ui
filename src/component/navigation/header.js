            ...
            <div className="row">
              <div className="col col-md-6 col-sm-12 col-12">
                <div className="contact-intro">
                  <ul>
                    <li>
                      <i className="fa fa-phone" /> +234-703 9378 492
                    </li>
                    <li>
                      <i className="fa fa-envelope" /> info@skilllink.org
                    </li>
                  </ul>
                </div>
              </div>
                  ...
                  <ul>
                    ...
                    <li>
                      <Link
                        to="/ourwork"
                        className={
                          this.props.location.pathname === "/ourwork"
                            ? "active"
                            : "inactive"
                        }
                      >
                    ...
                    <li>
                      <Link
                        to="/get/involved"
                        className={
                          this.props.location.pathname === "/get/involved"
                            ? "active"
                            : "inactive"
                        }
                      >
                    ...
                    <li>
                      <Link
                        to="/campaign/list"
                        className={
                          this.props.location.pathname === "/campaign/list"
                            ? "active"
                            : "inactive"
                        }
                      >
                    ...
                    {AuthenticationService.getToken() && (
                      <li>
                        ...
                        <ul>
                          ...
                          {AuthenticationService.getAdminStatus() && (
                            <li>
                              <Link
                                to="/dashboard"
                                className={
